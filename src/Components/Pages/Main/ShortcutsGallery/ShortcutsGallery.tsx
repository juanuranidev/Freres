...
const ShortcutsGallery = () => {
  return (
    <section className='shortcutsGallery'>
      <Link className="shortcutsGallery_a" to='/essential_outfits'><GaleryImage p='OUTFITS' img={ShorcutsGallery1} /></Link>
      <Link className="shortcutsGallery_a" to='/shop/camperasybuzos'><GaleryImage p='CAMPERAS Y BUZOS' img={ShorcutsGallery2} /></Link>
      <Link className="shortcutsGallery_a" to='/shop/all'><GaleryImage p='TODOS LOS PRODUCTOS' img={ShorcutsGallery3} /></Link>
    </section>
  );
}
