...
const MercadoPago = () => {
  return (
    <div className='mercadoPago'>
        ...
        <div className='otherTypeOfCards'>
            <div>
                <h3>TARJETAS DE DÉBITO</h3>
                <div>
                    <img className='cards_div_img' src="https://http2.mlstatic.com/storage/logos-api-admin/ce454480-445f-11eb-bf78-3b1ee7bf744c-xl@2x.png"/>
                    <img className='cards_div_img' src="https://http2.mlstatic.com/storage/logos-api-admin/d589be70-eb86-11e9-b9a8-097ac027487d-xl@2x.png"/>
                    <img className='cards_div_img' src="https://http2.mlstatic.com/storage/logos-api-admin/0daa1670-5c81-11ec-ae75-df2bef173be2-xl@2x.png"/>
                    <img className='cards_div_img cabal' src="https://http2.mlstatic.com/storage/logos-api-admin/c9f71470-6f07-11ec-9b23-071a218bbe35-xl@2x.png"/>
                </div>
            </div>
            <div>
                <h3>PAGOS EN EFECTIVO</h3>
                <div>
                    <img className='cards_div_img' src="https://www.mercadopago.com/org-img/MP3/API/logos/pagofacil.gif"/>
                    <img className='cards_div_img' src="https://www.mercadopago.com/org-img/MP3/API/logos/rapipago.gif"/>
                </div>
            </div>
        </div>
        <div className='payment'>
            <img src="https://freres.ar/wp-content/plugins/woocommerce-mercadopago/assets/images/redirect_checkout.png"/>
            <h3>TE LLEVAMOS A NUESTRO SITIO PARA REALIZAR EL PAGO</h3>
        </div>
    </div>
  );
}
